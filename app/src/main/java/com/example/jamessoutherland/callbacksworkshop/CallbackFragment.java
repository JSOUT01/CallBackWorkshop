package com.example.jamessoutherland.callbacksworkshop;
...
public class CallbackFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Uses layout created to associated it with this particular fragment.
    ...
    //Required to be able to instantiate the fragment for use. GENERATED FOR US WHEN TYPING IN "NEW" AND SELECTING A newInstance.
    ...
    //Allow the Callback class to be used or "Called" from classes that implement it.
